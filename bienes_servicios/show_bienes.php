...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Información del bien</h1>
          </div><!-- /.col -->
            ...
            <div class="card-body" style="display: block;">
              ...
              <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="id_categoría" class="form-control" value="<?php echo $des_categoria;?>" disabled> 
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="id_proveedor" class="form-control" value="<?php echo $nombre_prov;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label for ="">Unidad de medida:</label>
                    <input type="text" name="id_medida" class="form-control" value="<?php echo $abreviatura_med;?>" disabled>
                 <div class="form-group">
                    <label for ="">Costo:</label>
                    <input type="number" name="costo" class="form-control" value="<?php echo $costo;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label for ="">Moneda:</label>
                    <input type="text" name="id_moneda" class="form-control" value="<?php echo $descripcion_mon;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label for ="">Empleado:</label>
                    <input type="email" name="id_empleado" class="form-control" value="<?php echo $email;?>" disabled>
                  </div>
                  <div class="col-md-3">
                    <div>
                    ...
                    <hr>
                  <div class="form-group">
                    <a href="index_bienes.php" class="btn btn-secondary">Volver</a>

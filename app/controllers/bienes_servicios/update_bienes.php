...
$sql_bienes_servicios = "SELECT bn.*, tipo.des_tipo_bien_servicio,med.abreviatura_med,em.email,cat.des_categoria,mon.descripcion_mon,med.descripcion_med,pro.nombre_prov
...
WHERE bn.id_bien_servicio = :id_bien_servicio";

$query_bienes_servicios = $pdo->prepare($sql_bienes_servicios);
$query_bienes_servicios->bindParam(':id_bien_servicio', $id_bien_servicio_get, PDO::PARAM_INT);
...
foreach ($bienes_servicios_datos as $bien_servicio_dato){
    ...
    $descripcion_med = $bien_servicio_dato['descripcion_med'];

...
include('../app/controllers/mov_compra/show_mv.php');
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0">Eliminar comprobante </h1>
        </div><!-- /.col -->
          ...
          <div class="card card-danger">
            ...
            <div class="card-body" style="display: block;">
              <div class="col-md-12">
                ...
                <form action="../app/controllers/mov_compra/delete_mv.php" method="post">
                  ...
                  <div class="form-goup">
                    ...
                    <select name="id_documento" class="form-control" disabled>
                      <?php
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="codigo_comprobante" class="form-control"
                      value="<?php echo $codigo_comprobante; ?>" disabled>
                  </div>
                  <div class="form-group">
                    <div class="form-group">
                      <label for="">Nro de comprobante</label>
                      <input type="number" name="num_comprobante" class="form-control"
                        value="<?php echo $num_comprobante; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <div class="form-group">
                        <label for="">Descripcion</label>
                        <input type="text" name="des_mov_compra" class="form-control"
                          value="<?php echo $des_mov_compra; ?>" disabled>
                      </div>
                      <div class="form-goup">
                        <label for="">Fecha de compra:</label>
                        <input type="date" name="fecha_compra" class="form-control" value="<?php echo $fecha_compra; ?>" disabled>
                      </div>
                      <div class="form-goup">
                        <label for="">Fecha de pago:</label>
                        <input type="date" name="fecha_pago" class="form-control" value="<?php echo $fecha_pago; ?>" disabled>
                      </div>

                      <div class="form-group">
                        <label for="">Metodo de pago:</label>
                        <input type="text" name="metodo_pago" class="form-control" value="<?php echo $metodo_pago; ?>" disabled>
                      </div>
                      <div class="form-group">
                        <label for="">Estado de pago</label>
                        <input type="text" name="estado_pago" class="form-control" value="<?php echo $estado_pago; ?>"disabled>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="descuentos" class="form-control" value="<?php echo $descuentos; ?>"disabled>
                      </div>
                      <div class="form-group">
                        <label for="">Monto total</label>
                        <input type="number" name="monto_total" class="form-control" value="<?php echo $monto_total; ?>"disabled>
                      </div>
                      <div class="form-goup">
                        <label for="monedas">Moneda</label>
                        <select name="id_moneda" class="form-control" disabled>
                          <?php

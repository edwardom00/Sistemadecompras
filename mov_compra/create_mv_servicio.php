...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Registro del comprobante de servicio</h1>
                </div><!-- /.col -->
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="col-md-12">
                                <form action="../app/controllers/mov_compra/create_mv_servicio.php" method="post"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-goup">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="<?php echo "MS-" . ceros($contador_id_mov); ?>"
                                                            disabled>

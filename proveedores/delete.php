        ...
        <div class="col-md-8">
          <div class="card card-danger">
            ...
            <div class="card-body" style="display: block;">
              ...
              <form action="../app/controllers/proveedores/delete_prov.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="des_tipo_bien_servicio" class="form-control" value="<?php echo $des_tipo_bien_servicio;?>" disabled> 
                  </div>
                  <div class="form-group">

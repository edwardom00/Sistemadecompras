...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Categorias de servicios</h1>
                    <hr>
                                                ...
                                                <center>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header"
                                                                    ...
                                                                    <h4 class="modal-title">Actualizar categoria de servicio
                                                                    </h4>
                                                    ...
                                                    <script>
                                                        $('#btn_update<?php echo $id_categoria; ?>').click(function () {
                                                            ...
                                                            if (des_categoria == "") {
                                                                ...
                                                                var url = "../app/controllers/categorias/update_cat_servicios.php";
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header"
                                                                    ...
                                                                    <h4 class="modal-title">Eliminar categoria de servicio
                                                                    </h4>
                                                                    <button type="button" class="close" data-dismiss="modal"
                                                                        aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <script>
                                                        $('#btn_delete<?php echo $id_categoria; ?>').click(function () {
                                                            ...
                                                            var des_categoria = $('#des_categoria<?php echo $id_categoria; ?>').val();
                                                            var id_categoria = '<?php echo $id_categoria; ?>';
                                                            var url = "../app/controllers/categorias/delete_cat_servicios.php";
                                                            $.post(url, { des_categoria: des_categoria, id_categoria: id_categoria }, function (datos) {
...
<div class="modal fade" id="modal-create">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Crear categoria de servicios</h4>
...
<script>
    $('#btn_create').click(function () {
        ...
        if (des_categoria == "") {
            ...
            var url = "../app/controllers/categorias/registro_cat_servicios.php";
